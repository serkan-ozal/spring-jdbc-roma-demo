INSERT INTO USER (USERNAME, PASSWORD, FIRSTNAME, LASTNAME, ENABLED, GENDER, LANGUAGE, OCCUPATION, EDUCATION, BLOOD_TYPE, MARITAL_STATUS) VALUES ('user', 'password',  'Serkan', 'OZAL', 1, 1, 1, 300, 5, 1, 'SINGLE');
